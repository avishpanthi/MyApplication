...
// Obtain the SupportMapFragment and get notified when the map is ready to be
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        Button btnBanks = (Button) findViewById(R.id.rest);
        btnBanks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MapsActivity.this, "These are your Nearby Restaurants! ",
        ...
        viewList = (Button) findViewById(R.id.btn_list);
        viewList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                startActivity(new Intent(MapsActivity.this,ListViewActivity.class));
            }
        });
    }
